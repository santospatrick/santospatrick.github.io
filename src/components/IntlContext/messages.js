export default {
  en: {
    ...
    thoughts: {
      text: `<div>
          <p>
            I love my job as web developer and I found myself very happy within Front-End after a year working in the area. I have 5 years now with html, css and javascript consuming rest apis, developed 10+ projects (web and mobile) and i can say that many things have changed (for the better) since internet explorer 6 support. I have a lot of ideas for web components and boilerplates, most of them are at my <a href="https://github.com/santospatrick" target="_blank">github</a>, <a href="https://codepen.io/Piricuca/" target="_blank">codepen</a> and <a href="https://codesandbox.io/u/santospatrick" target="_blank">codesandbox</a> profiles. I am constantly studying about web development in <a href="http://egghead.io" target="_blank">egghead.io</a> and <a href="https://www.udemy.com/user/patrick-santos" target="_blank">udemy</a>. Also there are some values that I share and appreciate if my working environment has too:
          </p>
          <ul>
